...
S0 = gsw_SSO; % standard seawater salinity of 36.1650 in g/kg
...
%% continuation
continuecurrentrun  = 1; % set this to restart after using control-c to cancel the previous run
loadfromfile = 0; % load a start.mat file stored in the same directory
